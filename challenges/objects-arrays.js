...
console.log(rexObj.weight);

// What was the diet of a velociraptor?
console.log(raptorObj.diet);

// How long was a stegosaurus?
console.log(stegoObj.length);

// What time period did tyrannosaurus live in?
console.log(rexObj.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(rexObj.sound);
...
const contactInfo = graduates.map((first_name) => {
  ...
  return {'first-name': first_name.email}
...
const unisWithUni = graduates.filter((univerity) => {
  return univerity >= 'Uni';
});
...
*/
const displayNames = zooAnimals.forEach((animal_name) => {
  
  return animal_name >= animal_name.scientific_name
});
...
*/
const populationTotal = zooAnimals.reduce((population, state) => {
